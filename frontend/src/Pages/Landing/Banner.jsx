        ...
        <section className="bg-[#323232] text-white bg-opacity-100 backdrop-blur-2xl border border-gray-700  h-screen sm:h-full">
            <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
              <div className="mx-auto max-w-3xl text-center">
                <h1
                className="text-[#f4e5c2] bg-clip-text text-4xl font-extrabold text-transparent sm:text-6xl mb-4 leading-normal sm:leading-normal"
                >
                Manage Your Expenses
                </h1>
                <span className="sm:block text-3xl text-[#f4e5c2] text-transparent mt-2">Control Your Money</span>
